...
export class ContractsController {
  ...
  @Post(':id/renew') @Roles('ADMIN', 'MANAGER') renew(@Param('id', ParseUUIDPipe) id: string, @Body() d: RenewContractDto, @CurrentUser() u: JwtUser) { return this.service.renew(id, d, u.sub); }
  @Patch(':id') @Roles('ADMIN', 'MANAGER') update(@Param('id', ParseUUIDPipe) id: string, @Body() d: UpdateContractDto, @CurrentUser() u: JwtUser) { return this.service.update(id, d, u.sub); }
