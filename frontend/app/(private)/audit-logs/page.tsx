...
export default function AuditLogsPage() {
  ...
  const visible = useMemo(() => {
    ...
    return query ? logs.filter((log) => [log.action, log.entity, log.entityId, log.user?.email].some((value) => value?.toLowerCase().includes(query))) : logs;
  }, [logs, search]);
